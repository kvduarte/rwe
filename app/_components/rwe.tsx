...
export default function AboutUs() {
  ...
  return (
    <section id="rwe" className="bg-black text-white py-16 md:py-24 px-6 md:px-12 overflow-hidden">
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          
          <div className="relative">
            <div className="absolute -top-4 -left-4 w-24 h-24 border-t-2 border-l-2 border-red-600 z-10" />
            <div className="relative h-80 sm:h-115 md:h-125 w-full overflow-hidden hover:grayscale-0 transition-all duration-700 shadow-2xl">
              <img 
          ...
          <div className="space-y-8">
            <div className="space-y-2">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase leading-none tracking-tighter italic text-white">
                Muito além do <br />
                <span className="text-zinc-400">"The book is on the table"</span>
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-4">
              <div className="border-l-2 border-red-600 pl-4">
                <h4 className="font-bold uppercase text-sm tracking-widest mb-1 text-white">Imersão Total</h4>
                <p className="text-zinc-400 text-sm">Foco 100% na comunicação.</p>
              </div>
              <div className="border-l-2 border-zinc-700 pl-4">
                <h4 className="font-bold uppercase text-sm tracking-widest mb-1 text-white">Professor</h4>
                <p className="text-zinc-400 text-sm">Aprenda com quem atua há mais de 15 anos no mercado, possui certificações internacionais e mais de 8 mil horas de estudo do idioma.</p>
              </div>
            </div>
            ...
            <div className="pt-6">
              <button 
                ...
                className="group flex items-center gap-4 text-xs font-bold uppercase tracking-[0.2em] hover:text-red-600 transition-colors cursor-pointer text-white"
              >
              ...
              <div className={`transition-all duration-700 ease-in-out overflow-hidden ${showHistory ? 'max-h-96 opacity-100 mt-6' : 'max-h-0 opacity-0'}`}>
                <div className="bg-zinc-900/90 p-6 border-l-2 border-red-600 italic">
