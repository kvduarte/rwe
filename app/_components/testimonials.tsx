...
const testimonials = [
  ...
  },
  {
    ...
    content: "Sempre me interessei pelo idioma, mas foi ao decidir cursar Comércio Exterior que entendi a necessidade de falar inglês de verdade. Iniciei as aulas com o Teacher Filipe e, aos 19 anos, conquistei um estágio em uma multinacional. Hoje, como Analista Júnior, o inglês me dá a segurança necessária para conduzir responsabilidades complexas, como auditorias internacionais. As aulas foram divisores de águas na minha carreira.",
    image: "/aluna 2.jpeg"
  },
  {
    id: 3,
