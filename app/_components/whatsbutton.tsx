...
export function WhatsappButton() {
  return (
    <div className="fixed bottom-6 right-6 lg:bottom-10 lg:right-10 z-50 flex items-center group">
      ...
      {/* Tooltip elegante - Aparece no hover ou fica fixo no desktop */}
      ...
      >
        {/* Ícone via Phosphor para ser mais leve, ou mantenha seu Image se preferir */}
      ...
      {/* Tailwind não tem bounce-slow nativo, mas podemos adicionar no global.css ou usar um inline style simples */}
      <style jsx global>{`
